...
function css() {
	return E('style', {}, `
		...
		.sbl-title p{margin:0;color:rgba(255,255,255,.84);font-size:12px;line-height:1.3;max-width:720px}
		...
		.sbl-btn{min-height:30px;border-radius:7px;border:1px solid #c9d7e8;background:#fff;color:#245fc7;padding:0 12px;font-size:12px;font-weight:800;cursor:pointer;transition:background .15s,border-color .15s,box-shadow .15s,transform .15s}
		.sbl-btn:hover{border-color:#8fb2e8;box-shadow:0 4px 12px rgba(55,91,148,.10);transform:translateY(-1px)}
		.sbl-btn.primary{background:#2563eb;border-color:#2563eb;color:#fff;box-shadow:0 5px 14px rgba(37,99,235,.18)}.sbl-btn.danger{background:#ef5b50;border-color:#ef5b50;color:#fff}.sbl-btn.soft{background:rgba(255,255,255,.12);border-color:rgba(255,255,255,.28);color:#fff}.sbl-btn.soft:hover{background:rgba(255,255,255,.2);border-color:rgba(255,255,255,.42)}
		.sbl-tabs{height:38px;display:flex;align-items:center;gap:6px;padding:0 8px;margin:8px 0;border-radius:8px;box-shadow:none}
		.sbl-tab{height:28px;display:inline-flex;align-items:center;padding:0 14px;border:0;border-radius:6px;background:transparent;color:#4b6382;font-size:12px;font-weight:900;cursor:pointer}.sbl-tab.active{color:#fff;background:#2563eb;box-shadow:0 4px 10px rgba(37,99,235,.16)}
		.sbl-tab-panel{display:none}.sbl-tab-panel.active{display:block}
		.sbl-status-strip{display:flex;justify-content:space-between;align-items:center;gap:12px;margin:8px 0;background:#fff;border:1px solid #d6e1ef;border-radius:8px;padding:9px 12px;box-shadow:0 6px 18px rgba(41,67,104,.05)}
		.sbl-crumb{color:#5b6e88;font-weight:800}.sbl-enabled{display:inline-flex;align-items:center;border-radius:999px;background:#e8fbf0;color:#087b58;border:1px solid #bceacf;padding:5px 11px;font-weight:900;white-space:nowrap}
		...
		.sbl-overview-item,.sbl-stat{min-height:54px;background:#fff;border:1px solid #d6e1ef;border-radius:8px;padding:9px 11px;box-shadow:0 5px 16px rgba(41,67,104,.04);overflow:hidden}
		...
		.sbl-service-card{min-height:66px;border-left:3px solid #0f9f75}.sbl-service-meta{display:block;margin-top:5px;font-style:normal;font-size:11px;font-weight:900;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.sbl-service-meta.ok{color:#008763}.sbl-service-meta.danger{color:#dc2947}
		.sbl-main{display:grid;gap:10px}.sbl-op-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px}.sbl-op-card{min-height:112px;border:1px solid #d6e1ef;border-radius:8px;background:#fff;padding:13px;display:flex;flex-direction:column;justify-content:space-between}.sbl-op-card h3,.sbl-card>h3{margin:0 0 8px;font-size:14px;color:#213651}.sbl-op-card p{margin:0 0 14px;color:#697d96;line-height:1.45;min-height:32px}.sbl-core-card .sbl-op-actions{margin:10px 0 8px}.sbl-core-toggle{margin:2px 0 8px}.sbl-core-meta{color:#5f7088;font-size:12px;line-height:1.35}.sbl-core-meta span{color:#263959;font-weight:800}
		.sbl-grid{display:grid;grid-template-columns:minmax(0,1fr);gap:10px;align-items:start}.sbl-card{padding:12px;margin-bottom:8px}.sbl-settings{display:grid;grid-template-columns:1fr 1fr;gap:10px}.sbl-section{border:1px solid #dce7f6;border-radius:8px;padding:10px;background:#f8fbff}.sbl-section.compact{padding:8px 10px;margin-bottom:8px}.sbl-section h4{margin:0 0 6px;font-size:12px;color:#263959}
		.sbl-field{display:grid;grid-template-columns:108px minmax(0,1fr);align-items:center;gap:8px;margin:6px 0}.sbl-field>span{font-weight:800;color:#425672;text-align:right}.sbl-input{height:29px;border:1px solid #c8d6e6;border-radius:7px;background:#fff;color:#102038;padding:0 9px;width:100%;font-size:12px}.sbl-input:focus{outline:0;border-color:#7da5e7;box-shadow:0 0 0 2px rgba(37,99,235,.12)}.sbl-small-input{width:auto;min-width:118px}.sbl-search{flex:1 1 340px;min-width:240px}
		.sbl-mode-picker,.sbl-two{display:grid;grid-template-columns:1fr 1fr;gap:7px}.sbl-mode-btn{min-height:44px;border:1px solid #c8d6e6;border-radius:8px;background:#fff;color:#102038;padding:7px 10px;text-align:left;cursor:pointer}.sbl-mode-btn b{display:block;font-size:12px;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.sbl-mode-btn span{display:block;margin-top:3px;color:#7a8ba3;font-size:11px;line-height:1.2}.sbl-mode-btn.active{border-color:#7da5e7;background:#eef5ff;color:#2563eb;box-shadow:inset 3px 0 0 #2563eb}.sbl-mode-btn.active span{color:#2563eb}
		...
		.sbl-section-head{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 12px;margin-bottom:8px}.sbl-section-head h3{margin:0 0 3px;color:#213651;font-size:14px}.sbl-section-head p{margin:0;color:#6d7f98;line-height:1.35}
		.sbl-rules-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;align-items:stretch}.sbl-rules-grid>.sbl-card{margin-bottom:0}.sbl-rules-settings-card,.sbl-rules-status-card{display:grid;align-content:start;gap:8px}.sbl-rules-status-card h3,.sbl-rules-settings-card h3{margin-bottom:0}.sbl-rules{display:grid;grid-template-columns:1fr 1fr;gap:8px}.sbl-rules-flow{margin-top:0}.sbl-rule{display:grid;grid-template-columns:12px minmax(0,1fr) auto;gap:8px;align-items:center;border:1px solid #d7e2ef;border-radius:7px;background:#fbfcff;padding:7px 9px;min-height:42px}.sbl-dot{width:8px;height:8px;border-radius:999px;display:inline-block}.sbl-dot.ok{background:#008763}.sbl-dot.warn{background:#c87209}.sbl-rule-main b{display:block;font-size:12px;color:#102038;margin-bottom:2px}.sbl-rule-main span{display:block;color:#5f7088;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.sbl-pill{display:inline-flex;align-items:center;min-height:20px;border-radius:999px;padding:0 8px;font-size:11px;font-weight:900}.sbl-pill.ok{background:#eafaf2;color:#008763}.sbl-pill.warn{background:#fff4cf;color:#b76b05}
		.sbl-flow-row{display:grid;grid-template-columns:24px minmax(0,1fr) auto;gap:7px;align-items:center;border-bottom:1px solid #e3ebf4;padding:6px 0}.sbl-flow-row:last-child{border-bottom:0}.sbl-step{display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;border-radius:6px;background:#eef4ff;color:#315ed7;font-weight:900}.sbl-flow-main b{display:block;color:#102038;margin-bottom:1px}.sbl-flow-main span,.sbl-flow-meta{color:#5f7088;font-size:11px}
		.sbl-toolbar{padding:8px 10px;margin-bottom:8px}.sbl-source{min-height:28px;border-radius:6px;border:1px solid #cbd6e6;background:#fff;color:#102038;padding:0 11px;font-size:12px;font-weight:900;cursor:pointer}.sbl-source.active{background:#2563eb;border-color:#2563eb;color:#fff;box-shadow:0 4px 10px rgba(37,99,235,.16)}.sbl-summary{display:flex;gap:6px;flex-wrap:wrap;margin-bottom:8px}.sbl-chip{display:inline-flex;align-items:center;min-height:21px;border-radius:999px;border:1px solid #dbe3ef;background:#fbfcff;color:#5f7088;padding:0 8px;font-size:11px}.sbl-chip b{color:#102038;margin-left:3px}.sbl-chip.error{background:#fff3f5;color:#dc2947}.sbl-chip.warn{background:#fff8df;color:#b76b05}
		.sbl-log-list{border:1px solid #d7e2ef;border-radius:7px;overflow:auto;max-height:calc(100vh - 405px);min-height:360px;background:#fff}.sbl-log-row{display:grid;grid-template-columns:38px 142px 58px minmax(0,1fr) 74px;gap:7px;align-items:center;min-height:28px;border-bottom:1px solid #e3ebf4;border-left:3px solid #4168d9;padding:2px 8px}.sbl-log-row:last-child{border-bottom:0}.sbl-log-row.warn{background:#fffdf2;border-left-color:#c87209}.sbl-log-row.error{background:#fff8fa;border-left-color:#f23655}.sbl-log-index{font-size:11px;color:#7a8ba3;text-align:right;font-weight:900}.sbl-log-time{font:11px/1.3 ui-monospace,SFMono-Regular,Consolas,monospace;color:#5f7088;background:#f5f7fb;border-radius:5px;padding:2px 6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.sbl-log-level{justify-self:start;min-width:42px;border-radius:5px;padding:2px 6px;text-align:center;font-size:10px;font-weight:900;background:#e9f2ff;color:#1d6bd8}.sbl-log-level.warn{background:#fff1c2;color:#a46500}.sbl-log-level.error{background:#ffe0e7;color:#c62844}.sbl-log-level.debug{background:#eef2f7;color:#5f728b}.sbl-log-msg{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:#102038}.sbl-log-topic{text-align:right;color:#5f7088;font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
		.sbl-footer{justify-content:flex-end;margin-top:4px}
