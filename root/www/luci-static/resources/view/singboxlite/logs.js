...
function css() {
	return E('style', {}, `
		...
		.sbll-page{color:#0f1f35;font-size:12px;margin:-12px;padding:12px 18px 18px;background:linear-gradient(180deg,#5f70e8 0,#5f70e8 62px,#eaf2ff 62px,#f7fbff 100%);min-height:calc(100vh - 110px)}
		...
		.sbll-hero{position:relative;overflow:hidden;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 16px 10px;margin-bottom:8px;background:linear-gradient(115deg,#204d76 0,#276be2 62%,#60a4ff 100%);border-color:rgba(255,255,255,.28);color:#fff;min-height:112px;box-sizing:border-box}
		...
		.sbll-tabs{height:40px;display:flex;align-items:center;gap:6px;padding:0 10px;margin:8px 0;border-radius:8px;box-shadow:0 12px 28px rgba(64,91,160,.08)}
		.sbll-tab{height:28px;display:inline-flex;align-items:center;padding:0 14px;border:0;border-radius:7px;background:transparent;color:#4b6382;font-size:12px;font-weight:900;cursor:pointer}
		.sbll-tab.active{color:#fff;background:#2563eb;box-shadow:0 6px 14px rgba(37,99,235,.22)}
